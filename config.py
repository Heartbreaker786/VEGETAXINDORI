...
UPSTREAM_REPO = getenv(
    "UPSTREAM_REPO",
    "https://github.com/Heartbreaker786/VEGETAXINDORI",
)
...
# Images
START_IMG_URL = getenv("START_IMG_URL", "https://te.legra.ph/file/b91a9c2660a1e4660b094.jpg")

PING_IMG_URL = getenv(
    "PING_IMG_URL",
    "https://te.legra.ph/file/b91a9c2660a1e4660b094.jpg",
)
...
if PING_IMG_URL:
    if PING_IMG_URL != "assets/Ping.jpeg":
        if not re.match("(?:http|https)://", PING_IMG_URL):
            PING_IMG_URL = "https://te.legra.ph/file/b91a9c2660a1e4660b094.jpg"

if START_IMG_URL:
    if START_IMG_URL != "assets/Ping.jpeg":
        if not re.match("(?:http|https)://", START_IMG_URL):
            START_IMG_URL = "https://te.legra.ph/file/b91a9c2660a1e4660b094.jpg"
